                            ...
                            <div className="col-lg-8 posts-list">
                                <div className="single-post">
                                    ...
                                    <div className="blog_details">
                                        <h2>Second divided from form fish beast made every of
                                            seas
                                    ...
                                    <div className="navigation-area">
                                        <div className="row">
                                            <div
                                                ...
                                                <div className="thumb">
                                                    <a href="#">
                                                        <img className="img-fluid" src="assets/img/post/preview.png"
                                                             alt=""/>
                                                    </a>
                                                </div>
                                                <div className="arrow">
                                            ...
                                            <div
                                                ...
                                                <div className="thumb">
                                                    <a href="#">
                                                        <img className="img-fluid" src="assets/img/post/next.png"
                                                             alt=""/>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div className="media align-items-center">
                                        <img src="assets/img/blog/author.png" alt=""/>
                                            <div className="media-body">
                                                ...
                                                <p>Second divided from form fish beast made. Every of seas all gathered
                                                    use saying you're, he
